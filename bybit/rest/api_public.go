...
func (b *ByBit) GetServerTime() (timeNow int64) {
...
//GetKLine https://bybit-exchange.github.io/docs/inverse/#t-httprequest-2
...
//GetTradingRecords  from: From ID. Default: return latest data
