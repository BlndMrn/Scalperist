...
//GetPositionFutures USDT contract
func (b *ByBit) GetPositionFutures(symbol string) (result []PositionFutures, err error) {
	var r GetPositionResultFutures
	...
	for _, v := range r.Result {
		result = append(result, b.convertPositionFutures(v))
	}
	return
}
...
func (b *ByBit) convertPositionFutures(position PositionFutures) (result PositionFutures) {
	...
	result.Isolated = position.Isolated
	...
	result.FreeQty = position.FreeQty
	result.TpSlMode = position.TpSlMode
